...
import { Home, Settings, User, BarChart3, Link } from "lucide-react"
...
export const Default: Story = {
  parameters: {
    docs: {
      description: {
        story:
          "좌측과 우측 각 영역에 Width, Header, Body 구조를 사용할 수 있습니다. 각 영역을 독립적으로 구성할 수 있습니다.",
      },
    },
  },
  render: () => (
    <Dashboard 
      ...
      gap={10}
    >
      <Dashboard.Sidebar className="fixed top-0 left-0 h-screen z-50">
        <Dashboard.Sidebar.Width className="py-4 pl-4 w-full">
      ...
      <Dashboard.Content className="bg-gray-100">
        <Dashboard.Content.Width className="flex flex-col h-full bg-gray-100">
